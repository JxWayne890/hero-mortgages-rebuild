  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center text-white bg-cover bg-center overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 px-6 py-12 max-w-4xl md:max-w-5xl mx-auto text-center text-white">
          <h2 className="text-sm md:text-base tracking-widest uppercase font-light mb-6 text-white/90">
            OVER{' '}
          ...
          <div className="border border-white/40 rounded-md px-8 py-6 backdrop-blur-sm shadow-xl shadow-black/10">
            <h1 className="text-4xl md:text-6xl font-light tracking-tight leading-tight mb-4 text-white">
              DSCR <span className="font-semibold">FINANCING</span>
            </h1>
            <p className="text-base md:text-lg leading-relaxed tracking-wide text-white/80">
          ...
          {/* Featured On */}
          <div className="pt-20">
            <p className="uppercase text-sm mb-4 tracking-wider text-white/90 text-center">
              FEATURED ON
            </p>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "logo":
              "https://i0.wp.com/timothyhero.com/wp-content/uploads/2021/10/imageedit_145_7304928946.png?resize=768%2C553&ssl=1",
            sameAs: [
