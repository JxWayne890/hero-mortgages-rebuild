      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center text-white bg-cover bg-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 py-12 max-w-3xl mx-auto text-center text-white">
          ...
          <div className="border border-white/40 rounded-md px-8 py-6 backdrop-blur-sm shadow-md">
            ...
            <p className="md:text-lg tracking-wide text-white/80 mx-px text-xs">
            ...
            <div className="backdrop-blur-sm bg-white/10 rounded-xl px-6 py-4 shadow-lg">
              <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-4 max-w-6xl mx-auto">
                ...
                <a href="https://www.wealthandfreedomnexus.com/" target="_blank" rel="noopener noreferrer">
                  <img src="https://www.wealthandfreedomnexus.com/_imagecache/Wealth%20_%20Freedom%20Nexus%20logo.png" alt="Wealth & Freedom Nexus" className="h-full max-h-10 w-auto max-w-[140px] object-contain hover:opacity-90 transition duration-150" />
                </a>

                <a href="https://lady-landlords.com/" target="_blank" rel="noopener noreferrer">
                  <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/20PxflUd1jJhN6BCN0Kk/media/651fd7cd3fadbf4c3e65a487.webp" alt="Lady Landlords" className="h-full max-h-10 w-auto max-w-[140px] object-contain hover:opacity-90 transition duration-150" />
                </a>

                <a href="https://www.mpamag.com/us" target="_blank" rel="noopener noreferrer">
                  <img src="https://www.mpamag.com/images/logo_us.svg" alt="MPA" className="h-full max-h-10 w-auto max-w-[140px] object-contain hover:opacity-90 transition duration-150" />
                </a>

                <a href="https://www.biggerpockets.com/" target="_blank" rel="noopener noreferrer">
                  <img src="https://bpimg.biggerpockets.com/assets/logo/logo@2x-41cb3d87079ac1ef4371ac91cbb08387cebf25d485e016645a632fa3709b6935.png" alt="BiggerPockets" className="h-full max-h-10 w-auto max-w-[140px] object-contain hover:opacity-90 transition duration-150" />
                </a>
